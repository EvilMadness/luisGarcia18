...
<?php
    ...
    require_once "practicas/conexion.php";
    // Escribimos la consulta para recuperar los registros de la tabla de MySQL
    $sql = 'SELECT E.numero, E.nombre, E.salario, E.categoria, E.sexo, D.descripcion FROM prograweb.empleados E INNER JOIN prograweb.departamentos D ON E.departamento = D.departamento';
