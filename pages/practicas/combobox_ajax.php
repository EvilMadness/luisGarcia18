...
/* La siguiente función se ejecuta cuando es invocada por un cambio en el control de la lista de departamentos. */
	function pedirEmpleados(){
		...
		objeto_AJAX.send("departamento_seleccionado="+document.getElementById("Combodepartamento").value);
	}
...
/* La siguiente función se ejecuta cuando se recibe una respuesta del servidor. */
	function muestraResultado(){
		...
		{
		   document.getElementById("ComboEmpleados").innerHTML = objeto_AJAX.responseText;
		}
	}
</script>
     ...
     <div id="texto1"><br>
      <p><?php echo $result;?></p>
        ...
        <fieldset style="width:90%"    >
          ...
          <br />
          <form action="detalle_empleados.php" method="post" id="formulario1">
                <div>
                    <p>
                      <label for="Combodepartamento">Id del departamento:</label>
                      <select name="Combodepartamento" id="Combodepartamento" onChange="javascript:pedirEmpleados();">
                    ...
                    <p>
                      ...
                      <input type="submit" name="buscarEmpleados" value="  Buscar datos de los empleados " />
                    </p>
                </div>
            </form>
        </fieldset> 
