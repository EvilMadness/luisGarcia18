<?php
    ...
    $sql2 = 'SELECT E.numero, E.nombre, E.salario, E.categoria, E.sexo, E.departamento, D.descripcion FROM empleados E ';
...
<div id="wrapper">
   ...
   <div id="caja4">
     <div id="texto1"><br>
      <p><?php //echo $result;?> <?php //echo $result2;?></p>
                ...
                <div>
                    <br />
                      ...
                      <option value="0">-- Selecciona un departamento --</option>
					    ...
					    ?>
                      <option value="<?php echo $row['departamento']; ?>" selected><?php echo $row['descripcion']; ?></option>
                      </select>
                    <br />
                    <br />
                    Número de empleado: 
                    <input type="text" name="txtnumero" id="txtnumero" size="10" value="<?php echo $row['numero']; ?>"
                    disabled />
                    <br />
                    <br />
                         Nombre de empleado: 
